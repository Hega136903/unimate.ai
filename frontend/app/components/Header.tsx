          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <button 
                ...
                className={`text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors ${activeSection === 'ai-features' ? 'text-purple-600 dark:text-purple-400 font-semibold' : ''} flex items-center space-x-1`}
              >
                <span>🤖</span>
              ...
              <button 
                ...
                className={`text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors ${activeSection === 'ai-chat' ? 'text-purple-600 dark:text-purple-400 font-semibold' : ''} flex items-center space-x-1`}
              >
                <span>💬</span>
                <span>AI Chat</span>
              </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
              ...
              <button 
                onClick={() => handleNavClick('ai-features')}
                className={`block px-3 py-2 rounded-md text-gray-700 dark:text-gray-300 w-full text-left ${activeSection === 'ai-features' ? 'text-purple-600 dark:text-purple-400 font-semibold' : ''}`}
              >
                🤖 AI Features
              </button>
              <button 
                onClick={() => handleNavClick('ai-chat')}
                className={`block px-3 py-2 rounded-md text-gray-700 dark:text-gray-300 w-full text-left ${activeSection === 'ai-chat' ? 'text-purple-600 dark:text-purple-400 font-semibold' : ''}`}
              >
                💬 AI Chat
              </button>
