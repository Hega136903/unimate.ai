            ...
            {isLoggedIn ? (
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-500 to-teal-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-green-600 hover:to-teal-600 transition-all duration-300 hover:shadow-xl hover:scale-105"
                >
      ...
      <div className="flex">
        ...
        <div className="w-64 bg-white dark:bg-gray-800 shadow-lg h-screen sticky top-0">
          <div className="p-6">
            ...
            <div className="mt-6">
              <button
                onClick={() => window.open('/?section=discovery', '_blank')}
                className="w-full bg-gradient-to-r from-green-500 to-teal-500 text-white px-4 py-3 rounded-lg font-medium hover:from-green-600 hover:to-teal-600 transition-all duration-300 flex items-center gap-2"
              >
                <span>🔍</span>
                Discover Portfolios
              </button>
