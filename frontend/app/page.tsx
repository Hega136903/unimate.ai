...
import AIFeatures from './components/AIFeaturesTest';
...
export default function Home() {
  ...
  return (
    <AuthProvider>
      <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark bg-gray-900' : 'bg-white'}`}>
        ...
        {/* AI Features - Only show when ai-features is active */}
        {activeSection === 'ai-features' && (
          <section id="ai-features" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 min-h-screen">
            <div className="max-w-6xl mx-auto px-4">
              <AIFeatures />
            </div>
          </section>
        ...
        {/* AI Chat Assistant - Only show when ai-chat is active */}
        {activeSection === 'ai-chat' && (
          <section id="ai-chat" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 min-h-screen">
            <div className="max-w-6xl mx-auto px-4">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                  🤖 AI Study Assistant
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">
                  Get help with your studies using our AI-powered assistant
                </p>
              </div>
              <AIChatAssistant />
            </div>
  ...
  {/* OpenAI Status Indicator removed */}
      </div>
    </AuthProvider>
  );
}
